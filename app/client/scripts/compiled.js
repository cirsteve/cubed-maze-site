...
/***/ function(module, exports, __webpack_require__) {
	...
	eval("__webpack_require__(1);\n(function webpackMissingModule() { throw new Error(\"Cannot find module \\\"./main\\\"\"); }());\n\n\n/*****************\n ** WEBPACK FOOTER\n ** multi main\n ** module id = 0\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///multi_main?");
...
/***/ function(module, exports) {
	...
	eval("// 7.2.9 SameValue(x, y)\nmodule.exports = Object.is || function is(x, y){\n  return x === y ? x !== 0 || 1 / x === 1 / y : x != x && y != y;\n};\n\n/*****************\n ** WEBPACK FOOTER\n ** ../~/babel-polyfill/~/core-js/modules/$.same-value.js\n ** module id = 45\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///../~/babel-polyfill/~/core-js/modules/$.same-value.js?");
...
/***/ function(module, exports, __webpack_require__) {
	...
	eval("// 20.1.2.3 Number.isInteger(number)\nvar isObject = __webpack_require__(18)\n  , floor    = Math.floor;\nmodule.exports = function isInteger(it){\n  return !isObject(it) && isFinite(it) && floor(it) === it;\n};\n\n/*****************\n ** WEBPACK FOOTER\n ** ../~/babel-polyfill/~/core-js/modules/$.is-integer.js\n ** module id = 69\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///../~/babel-polyfill/~/core-js/modules/$.is-integer.js?");
...
/***/ function(module, exports) {
	...
	eval("// 20.2.2.28 Math.sign(x)\nmodule.exports = Math.sign || function sign(x){\n  return (x = +x) == 0 || x != x ? x : x < 0 ? -1 : 1;\n};\n\n/*****************\n ** WEBPACK FOOTER\n ** ../~/babel-polyfill/~/core-js/modules/$.math-sign.js\n ** module id = 81\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///../~/babel-polyfill/~/core-js/modules/$.math-sign.js?");
...
/***/ function(module, exports) {
	...
	eval("// 20.2.2.14 Math.expm1(x)\nmodule.exports = Math.expm1 || function expm1(x){\n  return (x = +x) == 0 ? x : x > -1e-6 && x < 1e-6 ? x + x * x / 2 : Math.exp(x) - 1;\n};\n\n/*****************\n ** WEBPACK FOOTER\n ** ../~/babel-polyfill/~/core-js/modules/$.math-expm1.js\n ** module id = 85\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///../~/babel-polyfill/~/core-js/modules/$.math-expm1.js?");
...
/***/ function(module, exports, __webpack_require__) {
	...
	eval("'use strict';\nvar global      = __webpack_require__(6)\n  , $           = __webpack_require__(4)\n  , DESCRIPTORS = __webpack_require__(10)\n  , SPECIES     = __webpack_require__(33)('species');\n\nmodule.exports = function(KEY){\n  var C = global[KEY];\n  if(DESCRIPTORS && C && !C[SPECIES])$.setDesc(C, SPECIES, {\n    configurable: true,\n    get: function(){ return this; }\n  });\n};\n\n/*****************\n ** WEBPACK FOOTER\n ** ../~/babel-polyfill/~/core-js/modules/$.set-species.js\n ** module id = 123\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///../~/babel-polyfill/~/core-js/modules/$.set-species.js?");
